...
def build_html(print_mode: bool = False) -> str:
    ...
    raw_logs = {
        "Boyle": RAW_LOG_DIR / "agent-native" / "boyle-notebook-019ec667-6341-7e52-a2c3-0b1cccf9e8fa.jsonl",
        "Laplace": RAW_LOG_DIR / "agent-native" / "laplace-percent-cell-019ec667-910d-7222-b5c0-b0d2698617a3.jsonl",
        "Carson": RAW_LOG_DIR / "notebook-carson-019ec69e-fa32-7283-b6c6-fc26f2e1d8d8.jsonl",
        "Confucius": RAW_LOG_DIR / "percent-cell-confucius-019ec69f-3714-7170-8901-7d4a0f4d47bb.jsonl",
    }
...
{tabs_html}
  ...
  <section id="appendix" class="{panel_class}">
    ...
    <p>The page is generated by <code>scripts/build_report.py</code> from CSV files and raw JSONL logs included in this package. Plotly is vendored at <code>assets/plotly-2.35.2.min.js</code>.</p>
    ...
    <p>The names below are internal worker/log labels preserved so the raw JSONL logs, CSV rows, and prompts can be cross-checked.</p>
